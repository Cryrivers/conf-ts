...
- `preserveKeyOrder` applies to modifier arguments, callback results, nested
  modifiers, and object spreads. When calling transform and compile separately,
  pass the same value to both stages.
