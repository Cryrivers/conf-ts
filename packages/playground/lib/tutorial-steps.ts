...
`,
  ...
  },
  {
    ...
    description:
      'conf-ts supports JSX as a declarative syntax for nested structured data. When JSX is enabled, each element compiles to a plain `{ type, props }` object — no DOM or React involved.',
